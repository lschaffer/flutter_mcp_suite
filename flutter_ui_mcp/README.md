...
> [!NOTE]
> For dynamic generative UI rendering via Google's GenUI (`A2UI`) protocol, see the dedicated [`genui_mcp_playground`](../flutter_genui_mcp) package.
...
### [`LlmConfig`](../dart_mcp_core/lib/src/models/models.dart)
...
### [`McpServerConfig`](../dart_mcp_core/lib/src/models/models.dart)
...
### [`McpLocalTool`](../dart_mcp_core/lib/src/mcp/local_tools.dart)
