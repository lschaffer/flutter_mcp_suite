...
class GenuiTravelExampleApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'GenUI Travel & Accommodation Planner',
      debugShowCheckedModeBanner: false,
      themeMode: ThemeMode.system,
      theme: ThemeData(
        useMaterial3: true,
        colorScheme: ColorScheme.fromSeed(
          seedColor: const Color(0xFF0078D4), // Windows 11 Fluent Coastal Azure
      ...
      darkTheme: ThemeData(
        useMaterial3: true,
        colorScheme: ColorScheme.fromSeed(
          seedColor: const Color(0xFF2B88D8), // Fluent Dark Azure
...
class SerpApiTravelSearchTool extends McpLocalTool {
  ...
  Future<MCPToolResult> execute(Map<String, dynamic> arguments) async {
    ...
    final apiKey = EnvLoader.getSerpApiKey();
